...
def load_video_vspw_vps_json(json_file, image_dir, gt_dir):
    ...
    for ann in json_info["annotations"]:
        ...
        if video_id not in videoid_img_dic:
            continue
...
_PREDEFINED_SPLITS_PANOVSPW = {
    ...
    "panoVSPW_vps_video_val_0p3": (
        "VIPSeg/VIPSeg_720P/images",
        "VIPSeg/VIPSeg_720P/panomasksRGB",
        "VIPSeg/VIPSeg_720P/panoptic_gt_VIPSeg_val_rebuttal_0p3.json",
    ),
    "panoVSPW_vps_video_val_0p4": (
        "VIPSeg/VIPSeg_720P/images",
        "VIPSeg/VIPSeg_720P/panomasksRGB",
        "VIPSeg/VIPSeg_720P/panoptic_gt_VIPSeg_val_rebuttal_0p4.json",
    ),
    "panoVSPW_vps_video_val_0p5": (
        "VIPSeg/VIPSeg_720P/images",
        "VIPSeg/VIPSeg_720P/panomasksRGB",
        "VIPSeg/VIPSeg_720P/panoptic_gt_VIPSeg_val_rebuttal_0p5.json",
    ),
    "panoVSPW_vps_video_val_0p6": (
        "VIPSeg/VIPSeg_720P/images",
        "VIPSeg/VIPSeg_720P/panomasksRGB",
        "VIPSeg/VIPSeg_720P/panoptic_gt_VIPSeg_val_rebuttal_0p6.json",
    )
}
