...
@META_ARCH_REGISTRY.register()
class DVIS_Plus_offline(DVIS_Plus_online):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.classes_references_memory = Outputs_Memory_PerClasses(max_len=20)
